...
public class LivroAcademico extends Obra {

	private String autor;
	
	public LivroAcademico(String titulo,String autor,String editora,int edicao,
						  String anoPub,String ling,String tag,double valor,int quantPag,
...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		LivroAcademico[] livroAcad= new LivroAcademico[21];
		@SuppressWarnings("resource")
		Scanner ler = new Scanner(System.in);
		char opcao;
		
		carregamento(livroAcad);
...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		System.out.println("                     Livros Acadêmicos\n" +
		"1 Cadastrar\n" +
		"2 Buscar\n" +
		"3 Editar\n" +
		"4 Deletar\n" +
...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void imprime(LivroAcademico[] livroAcad)
	{
		System.out.println("                     Livros Acadêmicos");
		for(int cont=1;cont < livroAcad.length; cont++)
		{
			if(livroAcad[cont] != null)
				System.out.println(livroAcad[cont]);
		}
	}

///////////////////////////////////////////////////////////////////////////////////////////

	public static void carregamento(LivroAcademico[] livroAcad)
	{
		for(int cont=1; cont <= 5; cont++)
		{
			livroAcad[cont] = new LivroAcademico("livroacademico"+cont,"autor"+cont,
					 							 "editora"+cont,cont*1,""+(1997+cont),
					 							 "lingua"+cont,"tag"+cont,
					 							 cont*11.11,cont*11,cont*1.111,cont);
		}
	}
