...
public class HQ extends Obra {

	private String roteirista;
	private String ilustrador;

	public HQ(String titulo,String roteirista,String ilustrador,String editora,
...
///////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void imprime(HQ[] hq)
	{
		System.out.println("                     HQs");
		for(int cont=1;cont < hq.length; cont++)
		{
			if(hq[cont] != null)
				System.out.println(hq[cont]);
		}
	}
	
///////////////////////////////////////////////////////////////////////////////////////////	
	
	public static void carregamento(HQ[] hq)
	{
		for(int cont=1; cont <= 5; cont++)
		{
			hq[cont] = new HQ("hq"+cont,"roteirista"+cont,"ilustrador"+cont,"editora"+cont,
							  cont*1,""+(1997+cont),"lingua"+cont,"tag"+cont,cont*11.11,
